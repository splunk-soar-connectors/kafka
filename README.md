...
This table lists the configuration variables required to operate Kafka. These variables are specified when configuring a Kafka asset in Splunk SOAR.
...
[test connectivity](#action-test-connectivity) - Checks connectivity with configured hosts <br>
[on poll](#action-on-poll) - Ingest messages from Kafka <br>
